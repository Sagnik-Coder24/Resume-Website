...
export default {
  ...
  experience: [
    ...
    },
    {
      ...
      work_mode: "Hybrid",
      responsibilities: [
        "Collaborated with teams to translate business requirements into efficient technical solutions and optimized SQL databases for improved performance.",
        "Contributed to codebase documentation and managed incidents via ServiceNow to enhance operational efficiency and client satisfaction.",
      ],
      skills: ["SQL", "DBMS", "JavaScript", "Python", "Problem Solving"],
    },
    {
      company: "Cognizant",
      img: cts,
      ...
      work_mode: "Hybrid",
      responsibilities: [
        "Completed a comprehensive Full Stack Development training (Java, React.js, ADM), building full-stack applications.",
        "Improved user experience, functionality, scalability, and performance in applications.",
        "Specialized in Java back-end development, integrating React front-end components for efficient solutions.",
      ],
      skills: [
        "JavaScript",
        "React.js",
    ...
    },
    {
      ...
      work_mode: "Remote",
      responsibilities: [
        "Developed high-performance React.js apps, optimizing speed and responsiveness with React Hooks.",
        "Integrated REST APIs for dynamic data fetching and real-time updates, ensuring smooth frontend-backend interaction.",
        "Built scalable backend services with Java and Spring Boot, ensuring performance under high traffic.",
        "Optimized SQL databases with indexing and normalization for improved query performance.",
        "Used Git for version control, enhancing collaboration and development consistency.",
      ],
      skills: [
        "React.js",
        "JavaScript",
