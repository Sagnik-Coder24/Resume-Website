  ...
  experience: [
    {
      ...
      work_mode: "Hybrid",
      responsibilities: [
        "Built and maintained a Python app to calculate lost earnings from system misalignments, optimizing SQL data management, ensuring accurate fund disbursements to 10,000+ participants.",
        "Supported a Java app for managing participant data and investments, handling DBMS tasks, troubleshooting, and using ServiceNow for incident management, minimizing downtime and ensuring client satisfaction.",
        "Automated workflows to reduce manual tasks, save time, and increase productivity for clients and internal teams.",
        "Enhancing Full Stack Development skills (MERN) and problem-solving capabilities through consistent practice of Data Structures & Algorithms.",
      ],
      skills: ["React.js", "JavaScript", "Redux", "DSA", "Python", "SQL"],
    },
    {
      company: "Cognizant",
